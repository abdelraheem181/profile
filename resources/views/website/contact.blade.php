                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <form action="{{ route('contact.store') }}" method="POST">
                                    ...
                                    <!-- Phone number input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="phone_no" type="tel" name="phone_no" placeholder="(123) 456-7890" data-sb-validations="required" />
                                        <label for="phone_no">Phone number</label>
                                        <div class="invalid-feedback" data-sb-feedback="phone_no:required">A phone number is required.</div>
                                    </div>
                                    <!-- Message input-->
                                    <div class="form-floating mb-3">
